          ...
          <CardBody>
            <CardTitle>
              <h2 className='lifeTitle'>
                {' '}
                <FontAwesomeIcon icon='pills' className='icon' /> Risks
              </h2>
            </CardTitle>
            <Container>
              <Row>
                <Col sm={{ size: 'auto' }}>
                  <span id='riskGrade' className='riskGrade'>
                    {this.state.riskGrade}
                  </span>
                </Col>
                <Col lg='6' className='recommendation'>
                  <span className='addictDesc'>Recommendation</span>
                  <br></br>
                  <span className='addictTitle bigRec' id='recommendation'>
              ...
              <Row>
                <Col s='6'>
                  <span className='addictTitle'>
                    Medical Assisted Opioid Use
                  </span>
                  <br />
                  <span className='addictDesc'>{this.state.methuse}</span>
                </Col>
                <Col s='6'>
                  <span className='addictTitle'>Treatment</span>
                  <br />
              ...
              <Row>
                <Col s='6'>
                  <span className='addictTitle'>Prescriptions</span>
                  <br />
                  <span className='addictDesc'>{this.state.prescriptions}</span>
                </Col>
                <Col s='6'>
                  <span className='addictTitle'>Arrests</span>
                  <br />
