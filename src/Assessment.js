            ...
            <form ref="form" onSubmit={this.handleSubmit}>
              <Container>
                ...
                <Row>
                  ...
                  <Col s="6">
                    <span className="addictTitle">Medical Assisted Opiod Therapy</span><br />
              ...
              <Row align="center">
                <Col l="4" className="justify-content-center">
                  <button onSubmit={this.handleSubmit.bind(this)} className="activeStat justify-content-center" align="center" type="submit">Submit</button>
                </Col>
              </Row>
            </form>
          </CardBody >
